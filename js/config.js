...
const ADMIN_EMAILS = [
    'shahohussen505@gmail.com', // ئیمەیڵەکەی خۆت لێرە دابنێ
...
const GAME_CONFIG = {
    ...
    schedules: {
        ...
        evening: {
            time: "20:00",      // یاری سەرەکی لە کاتژمێر 8 شەو
            points: 500,
            tokens: 50,
            name: "یاری سەرەکی",
            icon: "🏆"
    ...
    settings: {
        ...
        adCooldown: 300,            // ماوەی چاوەڕوانی دووبارە سەیرکردنی ڕیکلام (چرکە) = 5 خولەک
...
const MESSAGES = {
    ...
    success: {
        ...
        adWatched: 'سوپاس! ١٠٠ تۆکنت وەرگرت!'
    },
    ...
    error: {
        ...
        adCooldown: 'تکایە چاوەڕێبە بۆ ڕیکلامی داھاتوو!'
    },
    
    // Info messages
    info: {
        gameStartsSoon: 'یاری سەرەکی بەم زووانە دەست پێ دەکات!',
        watchAdForTokens: 'سەیری ڕیکلام بکە بۆ بەدەستهێنانی ١٠٠ تۆکن!',
        gamePaused: 'یاریەکە ڕاگرا',
        profileImageComing: 'وێنەی پڕۆفایل لە بەشی داھاتوودا بەردەستدەبێت!',
        lowTokens: 'تۆکنەکانت کەمن! سەیری ڕیکلام بکە بۆ بەدەستهێنانی زیاتر.'
    },
    ...
    confirm: {
        ...
        purchasePowerup: 'دڵنیایت لە کڕینی ئەم توانایە?'
    }
};
