/**
 * UI Module - Enhanced Fixed Version
 */
...
function showScreen(screenId) {
    ...
    if (screen) {
        ...
        if (screenId === 'admin' && isAdmin) {
            ...
            startMainGameCountdownInterval();
        }
    }
...
/**
 * Update user UI - FIXED with proper field names
 */
async function updateUserUI() {
    ...
    try {
        ...
        const displayName = userData.displayName || 'یاریزان';
        ...
        // Update progress bar
        updateLevelProgress(totalScore);
        
        // Update token displays with animation
...
function animateTokenUpdate(newTokens) {
    const tokenElements = document.querySelectorAll('#shopTokens, #homeCoins, #userTokens, #profileTokens');
    
    tokenElements.forEach(el => {
        if (el) {
            el.classList.add('token-update');
            setTimeout(() => {
                el.classList.remove('token-update');
            }, 500);
        }
    });
}
...
async function loadLeaderboard() {
    ...
    try {
                ...
                <div class="leaderboard-item ${isCurrentUser ? 'current-user' : ''}">
                    ...
                    <div class="player-info">
                        ...
                        <div class="player-details">
                            <div class="player-name">${data.displayName || 'یاریزان'}</div>
        ...
        hideLoadingOverlay();
        showNotification('هەڵە لە بارکردنی پلەبەندی!', 'error');
    }
}

/**
 * Load user profile - ENHANCED
 */
...
function loadAchievements(userData) {
    const achievements = [
        ...
        },
        {
            ...
            icon: '🌟',
            unlocked: (userData.gamesPlayed || 0) >= 50
        },
        {
            id: 'hundred_games',
            name: '100 یاری',
        ...
        },
        {
            ...
            icon: '💫',
            unlocked: (userData.totalScore || 0) >= 10000
        },
        {
            id: 'rich',
            name: 'دەوڵەمەند',
        ...
        },
        {
            id: 'ten_wins',
            name: '10 بردنەوە',
            description: '10 یاریت بردەوە',
            icon: '🎯',
            unlocked: (userData.wins || 0) >= 10
        }
    ];
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-label">بردنەوە</div>
                </div>
            </div>
            ...
            <div class="stat-box">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-label">لەدەستدان</div>
                </div>
            </div>
...
async function loadGameHistory() {
    ...
    try {
        // Note: You would need to create a 'gameHistory' collection
        ...
        if (historyContainer) {
            historyContainer.innerHTML = `
                <div class="empty-message">
                    ...
                    <p>مێژووی یاریەکان لە نوێکردنی داھاتوودا زیاد دەکرێت</p>
                </div>
            `;
        }
    } catch (error) {
